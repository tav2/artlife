	  ...
	  <div class="page-title">
		 <div class="container">
			<h2><img src="assets/img/icons/logo2.png"> Поздравления <small></small></h2>
			<hr />
		 </div>
	  </div>
	  <!-- Page title -->
			...
			<div class="row">
				  <div class="col-md-12">
						   <div class="posts">
							  ...
							  <!-- Post one -->
							  <div class="entry ">
								 <h1 class="my_style1"><a href="blogsingle.html" >Поздравляем</a></h1>
								 ...
								 <!-- Thumbnail -->
								 <div class="bthumb">
									<a href="#"><img src="assets/img/pozdravl.jpg" alt="" class="img-responsive" /></a>
								 </div>
							  ...
							  <div class="entry">
								 ...
								 <!-- Thumbnail -->
								 <div class="bthumb">
									<a href="#"><img src="assets/img/pozdravl2.jpg" alt="" class="img-responsive" /></a>
								 </div>
