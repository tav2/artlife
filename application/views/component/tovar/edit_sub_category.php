        ...
        <div class="uk-width-1-1">
                ...
                <div class="uk-form-row">
                        <?php foreach($tovar_sub_category as $id): ?>
                            ...
                            <p>
                                <h4>Относится к категории:</h4>
                                <?php echo $this->dbmodel->get_sub_category_catname($id['tovar_category_id']); ?>
                            </p>
                            <p>
                ...
                if ($id['tovar_img_adres']) { ?>
                    <div>
                        ...
                        <a class="btn btn-default" href="/admin/components/tovar/delete_sub_category_img/<?=$id['tovar_sub_category_id'];?>" role="button">удалить &raquo;</a>
                    </div>
                <?php } endforeach ?>
        </div>
    </div>
